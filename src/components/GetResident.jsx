...
const GetResident = ({ URLresident }) => {
  ...
  return (
    <div className='row col offset-s1  s10 m4 l3 xl2' style={{ padding: "20px 10px", margin: "0" }}>
      ...
      <div className="card ">
...

        {
          residentInfo.status === "Alive"
            ? (
              <div className="card-reveal row blue lighten-1" style={{ border: "solid 2px blue", margin: "0.1%", overflow: "hidden" }}>
            ...
            : (
              <div className="card-reveal row red lighten-1" style={{ border: "solid 2px red", margin: "0.1%", overflow: "hidden" }}>
                <span className="card-title grey-text text-darken-4 col s12">
                  <i className="material-icons right">arrow_downward</i>
                </span>
                <p><b>Specie: </b> {residentInfo.species} </p>
